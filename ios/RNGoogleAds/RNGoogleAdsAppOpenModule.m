...
#import "RNGoogleAdsAppOpenModule.h"
#import "RNGoogleAdsCommon.h"
#import "common/RNSharedUtils.h"

@implementation RNGoogleAdsAppOpenModule
#pragma mark -
  ...
  [GADAppOpenAd loadWithAdUnitID:adUnitId
               ...
               completionHandler:^(GADAppOpenAd *_Nullable appOpenAd, NSError *_Nullable error) {
                 if (error) {
                   ...
                   [RNGoogleAdsCommon sendAdEvent:GOOGLE_ADS_EVENT_APP_OPEN
                                        requestId:requestId
                 ...
                 fullScreenContentDelegate.sendAdEvent = GOOGLE_ADS_EVENT_APP_OPEN;
