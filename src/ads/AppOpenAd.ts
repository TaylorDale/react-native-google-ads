...
export class AppOpenAd extends MobileAd implements MobileAdInterface {
  ...
  load() {
    ...
    this._googleAds.native.appOpenLoad(this._requestId, this._adUnitId, this._requestOptions);
  }
  ...
  show(showOptions?: AdShowOptions) {
    ...
    return this._googleAds.native.appOpenShow(this._requestId, options);
  }
}
