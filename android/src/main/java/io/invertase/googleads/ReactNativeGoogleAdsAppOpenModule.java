...
import static io.invertase.googleads.ReactNativeGoogleAdsEvent.GOOGLE_ADS_EVENT_APP_OPEN;
...
public class ReactNativeGoogleAdsAppOpenModule extends ReactNativeModule {
  private static final String SERVICE = "RNGoogleAdsAppOpenModule";
  private AppOpenAd appOpenAd = null;

  public ReactNativeGoogleAdsAppOpenModule(ReactApplicationContext reactContext) {
  ...
  private void sendAppOpenEvent(
    ...
    sendAdEvent(GOOGLE_ADS_EVENT_APP_OPEN, requestId, type, adUnitId, error);
  }
  ...
  public void appOpenLoad(int requestId, String adUnitId, ReadableMap adRequestOptions) {
    ...
    if (currentActivity == null) {
      ...
      sendAppOpenEvent(GOOGLE_ADS_EVENT_ERROR, requestId, adUnitId, error);
      return;
    }
                  ...
                  appOpenAd.setFullScreenContentCallback(
                      new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                          sendAppOpenEvent(GOOGLE_ADS_EVENT_CLOSED, requestId, adUnitId, null);
                          ReactNativeGoogleAdsAppOpenModule.this.appOpenAd = null;
                        }

                        @Override
                        public void onAdClicked() {
                          sendAppOpenEvent(GOOGLE_ADS_EVENT_CLICKED, requestId, adUnitId, null);
                        }

                        @Override
                        public void onAdShowedFullScreenContent() {
                          sendAppOpenEvent(GOOGLE_ADS_EVENT_OPENED, requestId, adUnitId, null);
                        }
                      });

                  ReactNativeGoogleAdsAppOpenModule.this.appOpenAd = appOpenAd;
                  sendAppOpenEvent(GOOGLE_ADS_EVENT_LOADED, requestId, adUnitId, null);
                }
